...
\begin{figure}
  \centering\setcounter{subfigure}{0}
  \subfloat[S21: crosstalk]{\includegraphics[width=0.45\textwidth]{2_crosstalk}}\quad
...
\begin{figure}
  \centering\setcounter{subfigure}{0}
  \subfloat[S11, S21: for all modes]{\includegraphics[width=0.45\textwidth]{5_3}}\quad
  \subfloat[S11, S21, S22]{\includegraphics[width=0.45\textwidth]{5_3_2}}\\
\end{figure}
\end{frame}
