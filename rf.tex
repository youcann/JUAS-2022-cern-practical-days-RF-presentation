...
\begin{figure}
  \centering\setcounter{subfigure}{0}
  \subfloat[Under Coupled]{\includegraphics[height=0.15\textwidth]{img/cav_under.png}}\;
  \subfloat[Critically Coupled]{\includegraphics[height=0.15\textwidth]{img/cav_crit.png}}\;
  \subfloat[Over Coupled]{\includegraphics[height=0.15\textwidth]{img/cav_over.png}}
\end{figure}
\end{frame}
