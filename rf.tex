...
\begin{figure}
  \centering
  \subfloat[Strip line: image and circuit]{\includegraphics[width=0.9\textwidth]{2_1}}\quad
%  \subfloat[b]{\includegraphics[width=0.45\textwidth]{2_S11_TD}}\\
%  \subfloat[Caption c]{\includegraphics[width=0.28\textwidth]{3_1}}\quad
%  \subfloat[Caption d]{\includegraphics[width=0.28\textwidth]{3_1}}
\end{figure}
...
\begin{figure}
  \centering
  \subfloat[Cavity setup]{\includegraphics[width=0.28\textwidth]{4_resume}}\quad
%  \subfloat[Caption b]{\includegraphics[width=0.28\textwidth]{3_1}}\\
%  \subfloat[Caption c]{\includegraphics[width=0.28\textwidth]{3_1}}\quad
%  \subfloat[Caption d]{\includegraphics[width=0.28\textwidth]{3_1}}
\end{figure}
\end{frame}
...
%  \subfloat[]{\includegraphics[width=0.28\textwidth]{3_1}}\quad
%  \subfloat[]{\includegraphics[width=0.28\textwidth]{3_1}}
\end{figure}
\end{frame}
